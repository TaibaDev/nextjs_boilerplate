...
export default function Home() {
  return (
    <main className="flex min-h-screen bg-pink-500 flex-col items-center justify-between p-24">
      <div className="py-52 text-3xl  text-white px-52 rounded-lg flex flex-col">
